...
class InfoPage extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _buildRow("App Version", "1.0.0 (Build 1)", themeColors, colors),
  ...
  Widget _buildRow(String label, String value, ColorScheme themeColors, AppColorsExtension colors) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            label,
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: themeColors.onSurface),
          ),
          Text(
            value,
