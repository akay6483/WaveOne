      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                _buildThemeTab(ThemeMode.light, Icons.wb_sunny_outlined, "Light", themeColors, colors),
                _buildThemeTab(ThemeMode.dark, Icons.nightlight_round_outlined, "Dark", themeColors, colors),
                _buildThemeTab(ThemeMode.system, Icons.settings_suggest_outlined, "Auto", themeColors, colors),
              ],
            ),
          ),
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Icon(icon, size: 24, color: isActive ? themeColors.onPrimary : colors.inactiveTint),
