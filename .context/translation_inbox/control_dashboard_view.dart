...
class ControlDashboardView extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Wrap(
                ...
                children: [
                  _buildModalButton("Attenuation", Icons.tune, themeColors, onOpenAttenuation),
                  _buildModalButton("Presets", Icons.save_alt, themeColors, onOpenPresets),
                  _buildModalButton("Remote", Icons.settings_remote, themeColors, onOpenRemote),
                ],
              ),
            ),
          ],
  ...
  Widget _buildModalButton(String label, IconData icon, ColorScheme themeColors, VoidCallback onTap) {
    return InkWell(
      onTap: onTap,
